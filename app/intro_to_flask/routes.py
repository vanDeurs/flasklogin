...
app.secret_key = '#wol3emit6lla920010416'

app.config["MAIL_SERVER"] = "smtp.gmail.com"
app.config["MAIL_PORT"] = 465
app.config["MAIL_USE_SSL"] = True
app.config["MAIL_USERNAME"] = 'wilsonvandeurs@gmail.com'
app.config["MAIL_PASSWORD"] = 'Hammarby2001'
...
def contact():
    ...
    if request.method == 'POST':
        if form.validate() == False:
            ...
            msg = Message(form.subject.data, sender='website@sender.com', recipients=['wilsonvandeurs@gmail.com'])
            msg.body = """
            From: %s <%s>
            %s
